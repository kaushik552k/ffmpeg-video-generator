/**
 * DEMO: Animated Render
 * --------------------------------------------------
 * Renders the EXACT same 30-second video and 5 layers
 * as demo_static.ts — BUT with FFmpeg-native animations
 * on every overlay layer (fade, slide, zoom).
 *
 * Run: npx tsx src/test/demo_animated.ts
 */
...
const composition: Composition = {
    ...
    trackItemsMap: {
        ...
        txt_heading: {
            ...
            animation: {
                in:  { type: 'fadeIn',     duration: 1200 },
                out: { type: 'fadeOut',    duration: 800  },
            },
            details: {
        ...
        txt_subtitle: {
            ...
            display: { from: 0, to: 30000 },
            animation: {
                in:  { type: 'slideInRight',  duration: 1000 },
                out: { type: 'slideOutRight', duration: 600  },
            },
            details: {
        ...
        lst_points: {
            ...
            animation: {
                in:  { type: 'slideInLeft',  duration: 900 },
                out: { type: 'slideOutLeft', duration: 600 },
            },
            details: {
        ...
        tbl_stats: {
            ...
            animation: {
                in:  { type: 'slideInBottom', duration: 1000 },
                out: { type: 'fadeOut',       duration: 800  },
            },
            details: {
...
async function main() {
    console.log('\n' + '═'.repeat(55));
    console.log('  🎬 DEMO — Animated Render (FFmpeg-native)');
    console.log('═'.repeat(55));
    console.log(`  Layers     : 1 video + 4 text overlays + 1 image`);
    console.log(`  Animations : fadeIn/Out · slideIn/Out · zoomIn/Out`);
    console.log(`  Length     : 30 seconds @ 1920×1080`);
    console.log('─'.repeat(55) + '\n');
    console.log('  Animation map:');
    console.log('    txt_heading   → fadeIn (1.2s) / fadeOut (0.8s)');
    console.log('    txt_subtitle  → slideInRight (1s) / slideOutRight (0.6s)');
    console.log('    lst_points    → slideInLeft (0.9s) / slideOutLeft (0.6s)');
    console.log('    tbl_stats     → slideInBottom (1s) / fadeOut (0.8s)');
    console.log('    img_logo      → zoomIn (1.5s) / zoomOut (0.8s)');
    console.log('─'.repeat(55) + '\n');
